...
// White Paper implementation of FXAA
// Taken from: https://github.com/PixelLightFoundation/pixellight/blob/master/Plugins/PLCompositing/src/Shaders/PostProcessing/FxaaShader.h
...
void main()
{
	frag_color =  vec4(FxaaPixelShader(fs_in.texcoord, deferred_texture, inv_res), 1.0);
}
