...
namespace bonobo
{
	...
	//! @param [in] using_other_aa if we are other AA
	//! @param [in] aa_num AA number in use
	...
	void saveConfig(std::string file_name, const bool &using_other_aa, const int &aa_num,
